            ...
            <div class="row">
                <div class="col">
                    <div class="header_content d-flex flex-row align-items-center justify-content-start">
                        <div class="logo"><a href="index.php">Evo. Electronics</a></div>
                        <nav class="main_nav">
                            <ul>
                                <li>
                                ...
                                <?php if (!isset($_SESSION['email'])) {
                                    ...
                                    echo "<li><a href='handlers/signout.php'>Signout</a></li>";
                                } ?>
                ...
                <div class="col">
                    <div class="search_panel_content d-flex flex-row align-items-center justify-content-end">
                        <form action="search.php" method="POST">
                            <input name="search-txt" type="text" class="search_input" placeholder="Search" required="required">
                        </form>
                    </div>
                </div>
            </div>
